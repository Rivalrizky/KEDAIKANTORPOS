...
//                    fileMenu = txNamaMenu.text.toString()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        back_input_data_menu_admin.setOnClickListener {
...
//                    db.whereEqualTo("file_name", doc.get(F_NAME)).get()
...
////                                val date = "$hari - $bulan - $tahun"
////
////                                val arr = doc.get("file_storage") as ArrayList<String>
////                                for (i in 0..arr.size - 1) {
////                                    Log.e("log", arr[i])
////                                    storage.child("""upload/$date/${arr[i]}""").delete()
